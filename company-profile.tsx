...
// SEO Metadata - Export this from a separate metadata.ts file in production
export const metadata: Metadata = {
  metadataBase: new URL("https://yourcompany.com"),
  title: {
    default: "Your Company Name | Leading Business Solutions Provider",
    template: "%s | Your Company Name",
  },
  description:
    "Your Company Name is a leading provider of innovative business solutions. We deliver excellence through cutting-edge technology and exceptional service since 2010.",
  keywords: [
    "business solutions",
    "corporate services",
  ...
  openGraph: {
    ...
    title: "Your Company Name | Leading Business Solutions Provider",
    description:
      "Innovative business solutions and exceptional service since 2010.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
